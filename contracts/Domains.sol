...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld)
        payable
        ERC721("Pongthorn-Sangkaphet Name Service", "TRONG1")
    {
    ...
    function register(string calldata name) public payable {
        ...
        console.log(
            "Registering %s.%s on the Name Service Smart Contract with tokenID %d",
            name,
            tld,
            newRecordId
        );
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the pongthsa", "image": "data:image/svg+xml;base64,',
